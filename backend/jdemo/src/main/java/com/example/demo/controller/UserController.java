...
import com.example.demo.model.dto.user.UserAddRequest;
import com.example.demo.model.dto.user.UserLoginRequest;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        boolean result = userService.save(user);  // user与数据库表记录是双向绑定的(v-model)
        if (!result) {
